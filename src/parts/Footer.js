              ...
              <div className="flex flex-col space-y-3 sm:space-y-4">
                {PersonalInfo.linkedin && (
                  <Button
                    ...
                    type="link"
                    target="_blank"
                    className="inline-flex items-center space-x-2 px-4 sm:px-5 md:px-6 py-1.5 sm:py-2 bg-[#0077b5] text-white rounded-lg hover:bg-[#005885] hover:shadow-lg hover:scale-105 transition-all duration-300 transform text-sm sm:text-base"
                    isExternal
                  >
                ...
                <Button
                  href="#"
                  type="link"
                  className="inline-flex items-center space-x-2 px-4 sm:px-5 md:px-6 py-1.5 sm:py-2 bg-[#24292e] text-white rounded-lg hover:bg-[#1a1e22] hover:shadow-lg hover:scale-105 transition-all duration-300 transform text-sm sm:text-base"
