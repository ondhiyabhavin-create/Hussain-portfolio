      ...
      <div className="container mx-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12 max-w-5xl lg:max-w-6xl mx-auto mb-8 sm:mb-10 md:mb-12">
          <Fade direction="up" triggerOnce>
            <div>
              <BrandIcon />
              <p className="mt-4 text-lg text-gray-600 leading-relaxed max-w-sm">
                {PersonalInfo.tagline}
              </p>
              <div className="mt-6 flex items-center space-x-2">
                <span className="text-2xl">👨‍💻</span>
                <span className="text-gray-600 font-medium">{PersonalInfo.yearsOfExperience} Years Experience</span>
              </div>
            </div>
          </Fade>
          ...
          <Fade direction="up" delay={200} triggerOnce>
            <div>
              <h2 className="text-2xl font-bold text-theme-blue mb-6">Contact</h2>
              <div className="space-y-4">
                <a
                  href={`mailto:${PersonalInfo.email}`}
                  className="flex items-center space-x-3 text-lg text-gray-600 hover:text-theme-purple transition-colors group"
                >
          ...
          <Fade direction="up" delay={400} triggerOnce>
            <div>
              <h2 className="text-2xl font-bold text-theme-blue mb-6">Connect</h2>
              {PersonalInfo.linkedin && (
                <Button
                  href={PersonalInfo.linkedin}
                  type="link"
                  target="_blank"
                  className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-theme-purple to-dark-theme-purple text-white rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300 transform"
                  isExternal
                >
                  <span>💼</span>
                  <span>LinkedIn</span>
              ...
              <div className="mt-8">
                <p className="text-gray-600 mb-4">Available for:</p>
