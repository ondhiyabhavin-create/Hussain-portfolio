...
export const Services = [
  {
    ...
    detailedDescription: "Expert database administration services covering a wide range of enterprise database platforms. I provide end-to-end solutions for Oracle Database , SQL Server, MongoDB, PostgreSQL, Oracle E-Business Suite, and Oracle Exadata. My services include database installation, configuration, performance tuning, high availability setup, disaster recovery planning, and 24/7 support. With extensive experience in mission-critical environments, I ensure optimal performance, security compliance, and zero-downtime operations across all database platforms.",
    features: [
